...
Gunakan paket self-contained dari **GitHub Releases**, bukan Source code ZIP.
...
6. Ikuti aktivasi Telegram pada popup extension.
7. Login ke portal reader dengan akun Anda sendiri.
8. Isi kode BMP dan rentang modul, lalu tekan **Mulai**.
